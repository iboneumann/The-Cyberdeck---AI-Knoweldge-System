...
Google results are not showing only top domains, but are always several pages from only a few domains, really.  
Finding information needs Google, being the only internet index currently.  
